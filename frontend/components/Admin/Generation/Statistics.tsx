...
const Statistics = ({ isGenerating, stats, setStats }: Props) => {
    ...
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>Real-time generation metrics</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-mono">{stats.duration || "00:00:00"}</span>
            </div>
            <div className="flex items-center justify-between text-sm">
